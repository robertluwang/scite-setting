...
You can append to end of SciTEGlobal.properties or place to SciTEUser.properties, I prefer first option because it will keep scite as portable, 2nd option will save to %USERPROFILE%/SciTEUser.properties by default, it broke portable rule.
